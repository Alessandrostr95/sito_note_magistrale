Un primo approccio per il [[Positional postings and phrase queries#^57798b|nostro problema]] è quello di considerare ogni coppia di termini **consecutivi** in un documento come una singola frase.
